...
import { SwitzerlandIncomeTaxService } from "./SwitzerlandIncomeTaxService";
import { ComputedIncomeTaxValues, IncomeTaxRules } from "./domain/types";

export class SwitzerlandIncomeTaxServiceImpl implements SwitzerlandIncomeTaxService {
